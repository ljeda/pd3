...
public class PDPanel extends JPanel {
	...
	private PDBinaryWordInputDialog _kWordDialog = new PDBinaryWordInputDialog("słowo k");
	private PDBinaryWordInputDialog _rWordDialog = new PDBinaryWordInputDialog("słowo r");
	private PDNonnegativeNumberInputDialog _nIterationNumberDialog = new PDNonnegativeNumberInputDialog("n");
	private PDScrollTextArea _qMixArea = new PDScrollTextArea("tQ (puste = domyślny)", 10, 12);
	private PDScrollTextArea _yMixArea = new PDScrollTextArea("tY (puste = domyślny)", 10, 12);
	private PDScrollTextArea _zMixArea = new PDScrollTextArea("tZ (puste = domyślny)", 10, 12);
