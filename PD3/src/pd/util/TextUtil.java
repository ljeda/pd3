...
public class TextUtil {
	...
	public static boolean[] getBitXorDifference(String firstText, String secondText, int letterBitLength) throws Exception {
		if (firstText == null || secondText == null) {
			throw new Exception("Nie Podałeś poprawnie tekstów do operacji różnicy symetrycznej.");
		}
		if (firstText.length() != secondText.length()) {
			throw new Exception("długości tekstów do operacji różnicy symetrycznej nie są " + "takie same.");
		}
	...
	private static final Random ensureGenerator(Random generator) {
		if (generator == null) {
			System.out.println("Używam domyślnego generatora liczb pseudolosowych w narzędziach tektstowych.");
